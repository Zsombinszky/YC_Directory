        ...
        <form action={formAction} className="startup-form">
            ...
            <div>
                ...
                <Input id="category" name="category" className="startup-form_input" required
                       placeholder="Startup Category (Tech, Health, Education, Banking)"/>
            ...
            <div data-color-mode="light">
                ...
                <MDEditor id="pitch" preview="edit" height={300} style={{borderRadius: 20, overflow: "hidden"}}
                          value={pitch} onChange={(value) => setPitch(value as string)} textareaProps={{
